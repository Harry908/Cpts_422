...
public final class HalsteadToken {
	public static final int[] OPERATORS = {
			// Arithmetic
			TokenTypes.MINUS, TokenTypes.MINUS_ASSIGN, TokenTypes.MOD, TokenTypes.MOD_ASSIGN, TokenTypes.PLUS,
			TokenTypes.PLUS_ASSIGN, TokenTypes.POST_DEC, TokenTypes.POST_INC, TokenTypes.ASSIGN, TokenTypes.DEC,
			TokenTypes.DIV, TokenTypes.DIV_ASSIGN, TokenTypes.INC, TokenTypes.STAR, TokenTypes.STAR_ASSIGN,

			// Bitwise
			TokenTypes.BAND, TokenTypes.BAND_ASSIGN, TokenTypes.BNOT, TokenTypes.BOR_ASSIGN, TokenTypes.BOR,
			TokenTypes.BSR, TokenTypes.BSR_ASSIGN, TokenTypes.BXOR, TokenTypes.BXOR_ASSIGN, TokenTypes.SL,
			TokenTypes.SL_ASSIGN, TokenTypes.SR, TokenTypes.SR_ASSIGN,

			// Conditions
			TokenTypes.GE, TokenTypes.GT, TokenTypes.NOT_EQUAL, TokenTypes.EQUAL, TokenTypes.LAND, TokenTypes.LOR,
			...
			TokenTypes.LITERAL_IF, TokenTypes.LITERAL_ELSE, TokenTypes.LITERAL_CONTINUE, TokenTypes.LITERAL_SWITCH,
			TokenTypes.CASE_GROUP, TokenTypes.LITERAL_CASE, TokenTypes.LITERAL_BREAK, TokenTypes.LITERAL_DEFAULT,
			TokenTypes.LITERAL_FINALLY, TokenTypes.LITERAL_RETURN, TokenTypes.LITERAL_THROW, TokenTypes.LITERAL_THROWS,
	...
	public static final int[] OPERANDS = { TokenTypes.LITERAL_THIS, TokenTypes.STRING_LITERAL, TokenTypes.NUM_DOUBLE,
			...
			TokenTypes.LITERAL_NULL, TokenTypes.LITERAL_FALSE, TokenTypes.LITERAL_TRUE, TokenTypes.IDENT };
